...
/**
 * Timezone data with abbreviations, UTC offsets, and associated names.
 * Source: https://github.com/dmfilipenko/timezones.json
 * 
 * Note: This data has been modified to include updates and corrections.
 */
...
export function getTimezoneByOffset(offset:number) {
